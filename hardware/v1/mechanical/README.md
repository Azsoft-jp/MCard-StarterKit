...
- `v1-stackup.svg`: flat-front, rear-only 6.8/8.5 mm thickness transition.
- `v1-product-concept-v4.png`: current skeleton/flat-front/rear-button reference.
- `v1-product-concept-v3.png`: superseded flat-rear appearance reference.
